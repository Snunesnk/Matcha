			...
			<div id="messages_component_container">
				...
				>
					<div className="message-feed-selection-container">
						<button
							className={'messages-category-btn' + (activeComponent === COMPONENTS.MESSAGE_LIST ? ' selected' : '')}
							onClick={() => { setActiveComponent(COMPONENTS.MESSAGE_LIST) }}
						>
							Messages
						</button>
						<button
							className={'messages-category-btn' + (activeComponent === COMPONENTS.NOTIFICATION ? ' selected' : '')}
							onClick={() => { setActiveComponent(COMPONENTS.NOTIFICATION) }}
						>
							Matchs
						</button>
					</div>
					<Grid
						...
						data-active={activeComponent === COMPONENTS.MESSAGE_LIST}
						className="responsive-component"
					>
